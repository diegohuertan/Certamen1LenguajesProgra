...
#line 105 "automataCelular.tab.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CREARAUTOMATA = 3,              /* CREARAUTOMATA  */
  YYSYMBOL_TIPOVECINDAD = 4,               /* TIPOVECINDAD  */
  ...
  YYSYMBOL_ENDLINE = 12,                   /* ENDLINE  */
  YYSYMBOL_YYACCEPT = 13,                  /* $accept  */
  YYSYMBOL_instrucciones = 14,             /* instrucciones  */
  YYSYMBOL_instruccion = 15,               /* instruccion  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CREARAUTOMATA",
  "TIPOVECINDAD", "DEFAULT", "S", "E", "I", "R", "COLOR", "NUMERO",
  "ENDLINE", "$accept", "instrucciones", "instruccion", "funcion",
  "endline", YY_NULLPTR
};
...
{
       8,     1,     7,     1,    15,     2,    11,    12,    13,    17,
       2,    10,     2,     9,    14,    16,    18,    19,    20
};

static const yytype_int8 yycheck[] =
{
       0,     3,    10,     3,     7,    12,    11,    11,     6,     8,
      12,     5,    12,     3,    11,    11,    11,     9,    11
};
...
{
       0,     3,    12,    14,    15,    16,    17,    10,     0,    15,
      17,    11,    11,     6,    11,     7,    11,     8,    11,     9,
      11
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* funcion: CREARAUTOMATA COLOR NUMERO NUMERO S NUMERO E NUMERO I NUMERO R NUMERO  */
#line 61 "automataCelular.y"
                                                                               {
        seir estado = crearSeir((yyvsp[-6].ival), (yyvsp[-4].ival), (yyvsp[-2].ival), (yyvsp[0].ival));
        automata = crearAutomataSimetrico((yyvsp[-10].strval), (yyvsp[-9].ival), (yyvsp[-8].ival), estado);
        imprimirAutomata(automata);
        }
#line 1110 "automataCelular.tab.c"
    break;


#line 1114 "automataCelular.tab.c"
